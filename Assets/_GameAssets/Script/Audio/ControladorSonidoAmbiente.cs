...
//Activa y desactiva un sonido al entrar o salir de una zona modificando el volumen para que entre o salga de forma suave
[RequireComponent(typeof(BoxCollider), typeof(AudioSource))]
public class ControladorSonidoAmbiente : MonoBehaviour
{
    [SerializeField]
    [Range(0, 10)]
